...
--
-- Host: 127.0.0.1
-- Creato il: Mag 13, 2021 alle 10:36
...
--
-- Dump dei dati per la tabella `utenti_allenamenti`
--

INSERT INTO `utenti_allenamenti` (`email_utente`, `nome_allenamento`, `g_s`, `progresso`, `data_start`) VALUES
('antus.longo@gmail.com', 'dimagrimento 1', 5, 100, '2021-05-13'),
('antus.longo@gmail.com', 'potenziamento 1', 5, 0, '2021-05-05');

--
-- Trigger `utenti_allenamenti`
--
DELIMITER $$
CREATE TRIGGER `check_progress` AFTER UPDATE ON `utenti_allenamenti` FOR EACH ROW IF(NEW.progresso>100.01) THEN update utenti_allenamenti 
set utenti_allenamenti.progresso=100.00 
where email_utente=NEW.email_utente and nome_allenamento=NEW.nome_allenamento and data_start=NEW.data_start; END IF
$$
DELIMITER ;
...
ALTER TABLE `utenti_allenamenti`
  ADD PRIMARY KEY (`email_utente`,`nome_allenamento`,`data_start`) USING BTREE;
